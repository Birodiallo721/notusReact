    ...
    <section className="w-full h-full min-h-screen bg-[#1E293B] ">
      ...
      >
        ...
        <div className="container mx-auto flex flex-col items-center py-32 ">
          <div className="w-md rounded-xl bg-[#E2E8F0] py-5 px-5">
            ...
            <form className="mx-7" onSubmit={onSubmitForm}>
              ...
              <label
                className="flex flex-row items-center font-semibold text-gray-700 mt-4 "
                htmlFor="Remember"
              >
                <input
              ...
              <button
                className="uppercase bg-[#1E293B] text-white font-bold w-full py-2.5 my-7 rounded active:bg-[#2f3f59] "
                type="submit"
              >
                Sign In
              </button>
